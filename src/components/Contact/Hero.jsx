          ...
          <section className="text-white space-y-8">
            ...
            <section className="flex-start gap-x-4">
              ...
              <section className="text-left space-y-6">
                <p className="font-bold text-[20px]">{t('footer.address')}</p>
                <div className="space-y-2">
                  <h2 className="text-[18px] font-medium">{t('contact.headOffice')}</h2>
                  <p className="text-sm">
                ...
                <section className="flex-items-center [ lg:gap-x-8 gap-x-6 ]">
                  <div className="space-y-2">
                    <h2 className="text-[18px] font-medium">Abuja {t('contact.office')}</h2>
                    <p className="text-sm">
                  ...
                  <div className="space-y-2">
                    <h2 className="text-[18px] font-medium">PH {t('contact.office')}</h2>
                    <p className="text-sm">
            ...
            <section className="flex-items-center gap-x-4">
              ...
              <section className="text-left space-y-2 font-bold">
                <p className="text-[20px]">{t('contact.telephone')}</p>
            ...
            <section className="flex-items-center gap-x-4">
              ...
              <section className="text-left space-y-2 font-bold">
                <p className="text-[20px]">{t('contact.email')}</p>
