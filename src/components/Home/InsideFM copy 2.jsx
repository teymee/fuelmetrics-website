  ...
  return (
    <main className="bg-black  insideFM-background">
      <section className="pb-40 container">
        ...
        <section className={`flex justify-between items-center transition-all duration-1000`}>
          {/* SECTION LEFT  */}
          <article className="w-[20%] opacity-30  transition-all duration-1000">
          ...
          <article className="w-[60%] shadow-2xl bg-[#171717]  transition-all duration-1000 ">
            <div className="center-content">
              <img
                src={articles[activeTab].img}
                alt=""
                className={ `${canMove ? "move-left" : ""}`}
              />
            </div>
          </article>
