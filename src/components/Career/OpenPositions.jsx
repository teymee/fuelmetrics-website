  ...
  return (
    <main className="py-20 container  [ lg:space-y-20 space-y-8 ]">
      <div className="text-center">
        ...
        <p className="subHeader">{t("career.comeJoin")}</p>
      </div>
        ...
        {positions?.map((position, index) => {
          ...
          return (
            ...
            >
              ...
              <button className=" text-white rounded-full bg-primary [ flex justify-items-end self-end ] [ lg:px-14 px-8 ] [ lg:py-4 py-2 ] ">
                {t("career.apply")}
              </button>
            </div>
          );
